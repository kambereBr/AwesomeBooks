...
**[awesomeBooks]** AwesomeBooks is a project that allows users to record and display their favorite books.
...
```sh
  cd my-folder
  git clone https://github.com/kambereBr/AwesomeBooks.git
```
...
Feel free to check the [issues page](https://github.com/kambereBr/AwesomeBooks/issues).
